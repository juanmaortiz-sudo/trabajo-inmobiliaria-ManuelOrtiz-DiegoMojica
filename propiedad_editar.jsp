...
<%
    ...
    if ("POST".equalsIgnoreCase(request.getMethod())) {
        ...
        try {
            ...
            if (boundary == null) {
                ...
                if (matriculaNew.isEmpty() || tituloNew.isEmpty() || precioNew.isEmpty() || tipoOfertaNew.isEmpty() || direccionNew.isEmpty() || idCiudadNew.isEmpty() || idTipoPropiedadNew.isEmpty() || idInmobiliariaNew.isEmpty()) {
                    ...
                    conexion.commit();
                    registrarAuditoria(conexion, idUsuarioSesion, "EDITA_PROPIEDAD", "propiedad", "id_propiedad=" + idPropiedad + ", titulo=" + tituloNew);
        ...
        if (mensajeExito != null) {
            response.sendRedirect("propiedad_ver.jsp?id=" + idPropiedad);
            return;
        }
    }
%>
...
<%@ include file="navbar.jspf" %>
    ...
    <div class="container mt-4">
        <div class="d-flex justify-content-between align-items-center mb-3">
            ...
            <a href="propiedad_ver.jsp?id=<%= idPropiedad %>" class="btn btn-secondary">Ver</a>
        </div>
        ...
        <div class="card">
            <div class="card-body">
                <form action="propiedad_editar.jsp?id=<%= idPropiedad %>" method="post" enctype="multipart/form-data">
                    <div class="row">
...
%>
                        <div class="col-md-3 mb-3">
                            <div class="card">
                                <img src="<%= imagenesActuales.get(i) %>" class="card-img-top" alt="Imagen <%= i + 1 %>" style="height: 150px; object-fit: cover;">
