...
%>
    ...
    <div class="container">
        ...
        <form action="completar_registro.jsp" method="post" enctype="multipart/form-data">
            <div class="form-group">
<%          if (!actualFoto.isEmpty()) { %>
                <div class="mb-3">
                    <p><label>Foto actual:</label></p>
                    <img src="<%= actualFoto %>" alt="Foto actual" class="img-fluid rounded-circle" style="max-width: 120px;" />
                </div>
<%          } %>
