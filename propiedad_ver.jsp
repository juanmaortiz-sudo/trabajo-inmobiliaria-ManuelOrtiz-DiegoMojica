...
<%
    ...
    if (conexion != null && idPropiedad > 0) {
        ...
        try {
            ps = conexion.prepareStatement("SELECT 1 FROM favorito WHERE id_usuario = ? AND id_propiedad = ?");
...
%>
    ...
    <!-- Barra de navegación -->
<%
    request.setAttribute("seccionActiva", "propiedades");
%>
<%@ include file="navbar.jspf" %>
    ...
    <div class="container mt-4">
        <div class="d-flex justify-content-between align-items-center mb-3">
            ...
            <div>
                <% if (esCliente) { %>
                <a href="cita_nueva.jsp?id=<%= idPropiedad %>" class="btn btn-success mr-2"><i class="fas fa-calendar-plus"></i> Agendar cita</a>
                <a href="solicitud_nueva.jsp?id=<%= idPropiedad %>" class="btn btn-primary mr-2"><i class="fas fa-file-alt"></i> Radicar solicitud</a>
                <% } %>
                <% if (esInmobiliaria) { %>
            ...
            <div class="col-md-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mt-3">
                            <% if (esFavorito) { %>
                            <a href="favorito_toggle.jsp?id=<%= idPropiedad %>&accion=quitar" class="btn btn-block btn-danger">
                                <i class="fas fa-heart"></i> Quitar de favoritos
                            </a>
                            <% } else { %>
                            <a href="favorito_toggle.jsp?id=<%= idPropiedad %>&accion=agregar" class="btn btn-block btn-outline-danger">
